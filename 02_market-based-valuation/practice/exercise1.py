# Write a Python script to calculate and plot the inner value of a European put option
...
C = [BSM_put_value(S0, K, 0, T, r, vol) for S0 in S] # calculate put option values
...
plt.title('European Put Option Value Plot')
plt.show()